...
<script>
    import { getSubcomponentCost, modifySubcomponentCost, downloadSubcomponentCostDetails } from "@/api/jiaxing/quotation"
        ...
        methods: {
            ...
            exportToExcel(){
                window.location.href = this.projectUrl
                    + '/admin/erp/jiaxing/quotation/downloadSubcomponentCostDetails?orderItm='+this.orderItm
            }
        }
    }
</script>
