                ...
                <el-form :inline="true" class="demo-form-inline">
                    ...
                    <el-form-item label="行号">
                        <el-select v-model="itmNo" placeholder="行号">
                            <el-option v-for="item in itms" :key="item" :label="item.key" :value="item.value"></el-option>
                        </el-select>
                    </el-form-item>
    ...
    export default {
        ...
        methods: {
            ...
            OnQueryItms() {
                ...
                getOrderNumber({ order: this.OredeNO })
                    .then(response => {
            ...
            OnQueryOrderView() {
                ...
                if(this.OredeNO.length > 0 && this.itmNo.length > 0){
                    ...
                    getOrderCostOverview({ order: this.OredeNO, itm: this.itmNo })
                        .then(response => {
