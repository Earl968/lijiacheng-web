            ...
            <el-col :span="24" :xs="24">
                ...
                <div class="table-container">
                    ...
                    <el-table :data="AssembleDemandDesignList" ref="table" border v-loading="tableLoading"
                        ...
                        <el-table-column label="计划开工日期" prop="planStartDate" width="120">
                        ...
                        <el-table-column label="评审日期" prop="reviewDate" width="120">
                            <template slot-scope="scope"> {{ formatDate(scope.row.reviewDate) }}</template>
                        </el-table-column>
                        <el-table-column label="期望预交日" prop="expectedPrepaymentDate" width="120">
                            <template slot-scope="scope"> {{ formatDate(scope.row.expectedPrepaymentDate) }}</template>
                        </el-table-column>
                        <el-table-column label="评审交期" prop="reviewDeliveryDate" width="120">
                            <template slot-scope="scope"> {{ formatDate(scope.row.reviewDeliveryDate) }}</template>
                        </el-table-column>
                        <el-table-column label="批号" prop="batchNumber" width="130"></el-table-column>
